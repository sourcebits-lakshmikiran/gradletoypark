...
*/
    ...
    public static final String ADMIN_USERNAME = "chriswk";
    public static final String ADMIN_PASSWORD = "chriswk";
    public static final String ADMIN_EMAIL = "christopher.kolstad@gmail.com";
